...
final class LCFA_Block_Patterns {
    ...
    public function register_blocks_and_patterns(): void {
        if (function_exists('register_block_type')) {
            register_block_type(self::SECTION_BLOCK, [
                'api_version'     => 3,
                'title'           => __('AI Bridge Section Shell', 'livecanvas-forge-ai'),
                'description'     => __('PHP-rendered section shell used by AI Bridge block patterns.', 'livecanvas-forge-ai'),
                'category'        => 'design',
                'attributes'      => [
                    'eyebrow' => [
                        'type'    => 'string',
    ...
    public function build_pattern_preview(array $args): array {
        ...
        $title = sanitize_text_field((string) ($args['title'] ?? __('AI Bridge generated pattern', 'livecanvas-forge-ai')));
        $description = sanitize_text_field((string) ($args['description'] ?? __('Generated by LiveCanvas AI Bridge from selected section markup.', 'livecanvas-forge-ai')));
        ...
        if ($title === '') {
            $title = __('AI Bridge generated pattern', 'livecanvas-forge-ai');
        }
    ...
    public function build_native_page_preview(array $args): array {
        $title = sanitize_text_field((string) ($args['title'] ?? __('AI Bridge native page preview', 'livecanvas-forge-ai')));
        if ($title === '') {
            $title = __('AI Bridge native page preview', 'livecanvas-forge-ai');
        }
        ...
        if (empty($content_parts)) {
            return [
                'ok'       => false,
                'message'  => __('Native page preview requires at least one known AI Bridge pattern.', 'livecanvas-forge-ai'),
                'missing'  => $missing,
                'library'  => $this->get_pattern_library(['include_content' => false]),
            ];
        }
    ...
    private function get_patterns(): array {
        return [
            [
                ...
                'title'       => __('AI Bridge conversion hero', 'livecanvas-forge-ai'),
            ...
            [
                ...
                'title'       => __('AI Bridge feature grid', 'livecanvas-forge-ai'),
    ...
    private function get_conversion_hero_pattern_content(): string {
        return '<!-- wp:livecanvas-forge-ai/section-shell {"eyebrow":"AI Bridge pattern","heading":"Build a focused WordPress page","variant":"hero","align":"wide"} -->'
    ...
    private function get_feature_grid_pattern_content(): string {
        return '<!-- wp:livecanvas-forge-ai/section-shell {"eyebrow":"AI Bridge pattern","heading":"Three focused reasons","variant":"features","align":"wide"} -->'
            . '<!-- wp:columns -->'
    ...
    private function describe_pattern_use(string $pattern_name): string {
        ...
        return __('Use as a WordPress-native fallback pattern generated by LiveCanvas AI Bridge.', 'livecanvas-forge-ai');
    }
    ...
    private function get_native_page_blueprint_definitions(): array {
        return [
            [
                ...
                'preview_title' => __('AI Bridge native starter landing', 'livecanvas-forge-ai'),
                'description'   => __('A compact native page composed from the AI Bridge hero and feature grid patterns.', 'livecanvas-forge-ai'),
                'pattern_names' => [
                    'conversion-hero',
                    'feature-grid',
                ],
            ...
            [
                ...
                'preview_title' => __('AI Bridge native hero preview', 'livecanvas-forge-ai'),
            ...
            [
                ...
                'preview_title' => __('AI Bridge native feature summary', 'livecanvas-forge-ai'),
