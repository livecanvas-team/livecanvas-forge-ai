...
final class LCFA_Design_System_Fallback_Executor {
    ...
    public function execute(array $payload, bool $dry_run): array {
        ...
        $writes = [];
        $warnings = [
            __('No Picostrap or Picowind design-system target was detected, so AI Bridge uses portable theme assets instead.', 'livecanvas-forge-ai'),
    ...
    private function build_css(array $tokens): string {
        $lines = [
            '/* Generated by LiveCanvas AI Bridge fallback design-system executor. */',
            ':root {',
        ];
