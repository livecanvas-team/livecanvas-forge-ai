    ...
    private function get_output_rules(string $framework): array {
        if ($framework === 'picowind') {
            return [
                ...
                'allow_page_level_inline_script' => false,
                'page_level_script_placement'    => 'footer',
                'prefer_daisyui_components'      => false,
                ...
                'notes'                          => [
                    ...
                    __('Use DaisyUI or Typography only when get_write_context reports current compiled evidence. Otherwise use plain Tailwind.', 'livecanvas-forge-ai'),
                    __('Use JavaScript only for required interactions, in managed page_js or an enqueued theme asset. Never embed scripts or layout CSS in editorial content.', 'livecanvas-forge-ai'),
