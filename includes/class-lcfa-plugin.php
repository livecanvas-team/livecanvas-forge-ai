...
final class LCFA_Plugin {
    ...
    private function __construct() {
        ...
        $this->context_builder = new LCFA_Context_Builder($this->environment, $this->inventory, $this->windpress_bridge);
        $this->command_deck = new LCFA_Command_Deck($this->environment, $this->inventory);
        $this->rest_api    = new LCFA_Rest_Api($this->environment, $this->inventory, $this->windpress_bridge, $this->context_builder, $this->command_deck);
        $this->admin       = new LCFA_Admin($this->environment, $this->installer, $this->inventory, $this->context_builder, $this->command_deck);
