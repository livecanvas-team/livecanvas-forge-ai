...
lcfa_assert_same('@livecanvas/ai-bridge-mcp@0.2.0-beta.3', $remote_codex_bundle['command'][2] ?? '', 'remote Codex bundle should use the secure AI Bridge MCP package');
...
$complete_remote_state = $codex_onboarding_state_method->invoke($admin_instance, [
    ...
    'mode'                => 'remote',
    'connection_strategy' => 'ai-bridge-session',
    'copy_command_string' => "codex mcp add livecanvas-ai-bridge --env LCFA_SITE_URL='https://remote.example/' -- 'npx' '-y' '@livecanvas/ai-bridge-mcp@0.2.0-beta.3'",
    'command_string'      => 'npx -y @livecanvas/ai-bridge-mcp@0.2.0-beta.3',
    'agent_start_tool'    => 'get_connection_handoff',
    'codex_config_snippet' => "[mcp_servers.livecanvas-ai-bridge]\ncommand = \"npx\"\nargs = [\"-y\", \"@livecanvas/ai-bridge-mcp@0.2.0-beta.3\"]\n\n[mcp_servers.livecanvas-ai-bridge.env]\nLCFA_SITE_URL = \"https://remote.example/\"",
