...
lcfa_assert_same(true, strpos($internal_bootstrap, '@livecanvas/ai-bridge-mcp@0.2.0-beta.1') !== false, 'remote admin bootstrap should use the pinned secure MCP package');
