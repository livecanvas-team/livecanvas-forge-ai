...
package_assert_true(in_array('livecanvas-forge-ai/docs/release-notes-0.2.0-beta.5.md', $entries, true), 'distribution zip should include release notes with current qualification limits');
