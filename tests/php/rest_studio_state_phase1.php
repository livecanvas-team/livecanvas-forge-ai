...
lcfa_assert_same('0.2.0-beta.1', $connection_handoff['mcp_package_expected'] ?? '', 'studio connection handoff should expose the exact expected beta MCP package version');
