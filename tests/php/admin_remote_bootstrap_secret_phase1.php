...
define('LCFA_VERSION', '0.2.0-beta.3');
define('LCFA_MCP_PACKAGE_SPEC', '@livecanvas/ai-bridge-mcp@0.2.0-beta.3');
...
foreach (['codex', 'opencode', 'claude', 'cursor'] as $client) {
    ...
    lcfa_remote_bootstrap_assert(($configuration['command'] ?? '') === 'npx -y @livecanvas/ai-bridge-mcp@0.2.0-beta.3', $client . ' should use the pinned secure MCP package');
