...
lcfa_wp7_assert_true(($connection_handoff['connection_handoff']['mcp_package_expected'] ?? '') === '0.2.0-beta.4', 'connection handoff should expose the exact expected beta MCP package version');
