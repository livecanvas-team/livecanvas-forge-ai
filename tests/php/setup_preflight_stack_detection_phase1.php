...
lcfa_assert_contains('Compatible LiveCanvas theme', $picostrap_output, 'preflight should summarize the compatible theme stack');
...
$clean_snapshot['picostrap_candidates'] = [];
