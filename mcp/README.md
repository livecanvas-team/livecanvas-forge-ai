...
When the configuration is generated by the WordPress onboarding, the **Configure and build this site** choice overrides the package default with `read,preview,write,media,theme_files,debug,cache,seo`; **Inspect only** generates `read,preview`.
