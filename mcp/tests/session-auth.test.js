...
async function main() {
  ...
  try {
    ...
    assert.strictEqual(snapshotRequest.headers['x-lcfa-mcp-package-version'], require('../package.json').version, 'protected requests should report the running MCP package version')
